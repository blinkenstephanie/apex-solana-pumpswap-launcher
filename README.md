...
[![Price](https://img.shields.io/badge/Lifetime_license-3_SOL-A78BFA?style=for-the-badge&labelColor=0A0A0F)](#-get-lifetime-access--3-sol)
...
[![Access](https://img.shields.io/badge/Code-Private_/_gated_access-64748B?style=for-the-badge&labelColor=0A0A0F)](#-what-you-get)
...
> The full launcher is **not** open-sourced here — access is gated after a **3 SOL lifetime** payment.
...
**Lifetime access** to the APEX Solana launch & trade terminal:

- Full self-hosted **Pump.fun / PumpSwap launcher**
...
- Updates for the life of this product line

> **No monthly fee. No seat tax. No credits.**  
> Pay **3 SOL** once. Run the terminal yourself.
...
- Free full source on GitHub (this repo is **sales + SEO/docs only**)
...
### One payment. Lifetime Solana launcher access.

</div>

1. **Send exactly `3 SOL`** to:

```text
BrVEU6aZ4RDaG5viqbr9yWeSRufYjmy7TBvx5WoHTxXB
```

2. **Message [@suntzuson](https://t.me/suntzuson) on Telegram** with:
   - your transaction signature  
   - the Telegram handle you want access tied to  

```text
Telegram: @suntzuson
https://t.me/suntzuson
```

3. **We unlock you** — install / access instructions for the **APEX launcher** (self-hosted).

⏱️ Typical unlock: as soon as payment confirms on-chain.

### Payment checklist

- [ ] Sent **3 SOL** (exact amount)
- [ ] Copied the **transaction signature**
- [ ] Messaged **[@suntzuson](https://t.me/suntzuson)** with the signature
...
```text
Pay 3 SOL → Message tx sig → Receive access → AI agent builds it locally → Launch on Pump.fun / PumpSwap
```

1. Get your access pack (after payment confirms)  
...
> **Tip:** Prefer agents that can run commands and edit files in your project folder. Paste the access instructions you receive after the 3 SOL payment — don’t share private keys in the prompt; let the agent use local env files you control.
...
- You pay on-chain to our receive wallet; launcher access is granted after confirmed payment.
...
No. APEX is a **paid lifetime** self-hosted terminal. This repo exists so people searching GitHub for Solana / Pump.fun / PumpSwap launchers can find a clear offer.
...
Re-send the tx signature to **[@suntzuson](https://t.me/suntzuson)** on Telegram. On-chain payment is the source of truth.
...
**[Pay & get access](#-get-lifetime-access--3-sol)** · **[Visit apexlauncher.fun](https://apexlauncher.fun)**
